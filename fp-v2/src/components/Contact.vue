  ...
  <body>
    <div id="contact"> 
      <div class="outer">
        ...
        <section class="top">
          <div class="blink">
            <h1>dm me 4 lessons</h1>
              <a href="https://twitter.com/PAKE_FIRATE" target="_blank">TWITTER</a>
          </div>
        </section>
        <!--
        <div id="grid">
...
export default {
  ...
  setup() {
    ...
    const goToSite = (producturl) => {
      window.open(producturl,'_blank');
    }

    return { goToSite, showModal }
  }
}
</script>
...
.blink {
animation: blinker .022s step-start infinite;
